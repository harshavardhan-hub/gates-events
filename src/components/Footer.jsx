...
import { NAV_LINKS, ASSETS, SOCIAL_LINKS } from '../utils/constants.js';
            ...
            <ul className="space-y-3">
              {NAV_LINKS.map((link) => (
                <li key={link.id}>
                  <Link
                    to={link.href}
                    className="text-gray-300 hover:text-white transition-colors duration-300 hover:pl-2"
                  >
                    {link.name}
                  </Link>
                </li>
          ...
          <div>
            ...
            <div className="space-y-4 text-gray-300">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <p className="font-medium">GATES Institute of Technology</p>
                  <p className="text-sm">Gooty, Ananthapur District</p>
